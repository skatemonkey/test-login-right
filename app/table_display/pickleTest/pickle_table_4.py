...
def random_modify(data):
    ...
    if action == "add_task" and data["models"]:
    ...
    elif action == "remove_task" and data["models"]:
        model = random.choice(data["models"])
        if model["features"]:
            feature = random.choice(model["features"])
    ...
    elif action == "add_feature" and data["models"]:
        model = random.choice(data["models"])
    ...
    elif action == "remove_feature" and data["models"]:
        model = random.choice(data["models"])
    ...
    elif action == "remove_model" and len(data["models"]) > 1:
        removed = data["models"].pop()
